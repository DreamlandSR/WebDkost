                                ...
                                <form method="POST" action="{{ route('register') }}" class="px-2">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-6 mb-3 mb-md-0">
                                            ...
                                            <input id="nama_depan" type="text" name="nama_depan" 
                                                   ...
                                                   placeholder="Your first name" value="{{ old('nama_depan') }}" required autofocus>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="nama_belakang" class="form-label auth-form-label">Nama belakang</label>
                                            <input id="nama_belakang" type="text" name="nama_belakang" 
                                                   class="form-control auth-input-modern" 
                                                   placeholder="Your last name" value="{{ old('nama_belakang') }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input id="no_hp" type="text" name="no_hp"
                                               class="form-control auth-input-modern" 
                                               placeholder="Your phone number" value="{{ old('no_hp') }}" required>
                                    </div>
